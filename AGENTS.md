<!-- SKILLS_INDEX_START -->
[Agent Skills Index]|root: ./agents|IMPORTANT: Prefer retrieval-led reasoning over pre-training for any tasks covered by skills.|skills|commit:{commit.md},create-a-plan:{create-a-plan.md},create-pr:{create-pr.md},pr:{pr.md}
<!-- SKILLS_INDEX_END -->
